...
export default function HomePage() {
	return (
		<div>
			<div className="max-w-xl mx-auto bg-white shadow-sm">
				{/* Header */}
				...
				<div className="px-4 pb-3">
					<p className="text-[15px] text-gray-900">
						This is a regular Facebook post mockup as viewed from
						the Desktop site. Easily add your own text here and drop
						your image below into the placeholder.
					</p>
				</div>
